...
chart.render();
var options = {
    series: [{ name: "Desktops", data: [0, 41, 35, 51, 49, 1, 69, 91, 148] }],
    chart: {
      height: 350,
      type: "line",
      zoom: { enabled: !1 },
    ...
    dataLabels: { enabled: !1 },
    stroke: { curve: "straight" },
    colors: (chartBarColors = getChartColorsArray("line_chart_basic2")),
    title: {
      text: "Product Trends by Month",
      align: "left",
      style: { fontWeight: 500 },
  ...
  chart = new ApexCharts(document.querySelector("#line_chart_basic2"), options);
chart.render();
var options = {
    series: [{ name: "Desktops", data: [0, 41, 35, 51, 49, 1, 69, 91, 148] }],
    chart: {
    ...
    dataLabels: { enabled: !1 },
    stroke: { curve: "straight" },
    colors: (chartBarColors = getChartColorsArray("line_chart_basic3")),
    title: {
      text: "Product Trends by Month",
      align: "left",
      style: { fontWeight: 500 },
  ...
  chart = new ApexCharts(document.querySelector("#line_chart_basic3"), options);
chart.render();
...
options = {
  ...
  series: [
    { name: "High - 2018", data: [26, 24, 4, 5, 6, 4, 1, 33] },
